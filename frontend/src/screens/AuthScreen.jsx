    ...
    <div className="auth">
      <aside className="auth__hero">
        ...
        <div className="auth__hero-content">
          <h2>The task management tool your team won't fight you over.</h2>
          <p>TaskTrack tracks tasks, surfaces what's blocking, and stays out of the way. Ship work, not status updates.</p>
        </div>
      </aside>
